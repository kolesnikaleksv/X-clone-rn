...
import { CommentsModalProps } from '@/type';
...
const CommentsModal = ({ selectedPost, onClose }: CommentsModalProps) => {
  ...
  return (
    ...
    >
      <View className="flex-row items-center justify-between px-4 py-3 bordber-b border-gray-100">
      ...
      {selectedPost && (
        <ScrollView className="flex-1">
          <View className="border-b border-gray-100 bg-white p4">
            <View className="flex-row">
              ...
              <View className="flex-1">
                <View className="flex-row items-center mb1">
              ...
              <View className="flex-1">
                ...
                >
                  {isCreatingComment ? (
                    ...
                    <Text
                      className={`font-semibold${commentText.trim() ? 'text-white' : 'bg-gray-500'}`}
                    >
                      Reply
                    </Text>
                  )}
